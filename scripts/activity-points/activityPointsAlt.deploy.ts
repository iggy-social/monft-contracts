// npx hardhat run scripts/activity-points/activityPointsAlt.deploy.ts --network monadTestnet
...
async function main() {
  ...
  if (networkName !== "hardhat") {
    ...
    console.log(`npx hardhat verify --network ${networkName} ${address} ${statsAddress} ${tldAddress} "${multiplier}"`);
  } else {
