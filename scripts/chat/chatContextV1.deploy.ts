// npx hardhat run scripts/chat/chatContextV1.deploy.ts --network monadTestnet

import { network } from "hardhat";

const contractName = "ChatContextV1";

const modTokenAddress = "0x84A6DBa749bb6261315aB76B30c70d03025A5F32";
...
async function main() {
  ...
  const instance = await contract.deploy(modTokenAddress, chatOwnerAddress, modMinBalance);
