// npx hardhat run scripts/token/monft.deploy.ts --network monadTestnet

import { network } from "hardhat";

const contractName = "MONFT";

const tokenName = "MONFT";
const symbol = "MONFT";
...
async function main() {
  ...
  if (networkName !== "hardhat") {
    ...
    console.log(`npx hardhat verify --network ${networkName} ${address} "${tokenName}" "${symbol}"`);
  } else {
